...
namespace JWT_ASPNetCore_Agung.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<string> Login(UserRoleVM userRoleVM)
        {
            ...
            dbparams.Add("@User_password", userRoleVM.User_password, DbType.String);
            var result = await Task.FromResult(_dapper.Get<UserRoleVM>("[dbo].[SP_Login_User]", dbparams, commandType: CommandType.StoredProcedure));
            ...
            var claims = new[]
            {
                ...
                new Claim("User_password",result.User_password),*/
