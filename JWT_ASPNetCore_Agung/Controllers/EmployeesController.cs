...
namespace JWT_ASPNetCore_Agung.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<int> Create(Employee data)
        {
            ...
            var result = await Task.FromResult(_dapper.Insert<int>("[dbo].[SP_Insert_Employee]", dbparams, commandType: CommandType.StoredProcedure));
            return result;
        }
        ...
        public Task<int> Update(Employee data)
        {
            ...
            var updateEmp = Task.FromResult(_dapper.Update<int>("[dbo].[SP_Update_Employee]",
                            dbparams,
