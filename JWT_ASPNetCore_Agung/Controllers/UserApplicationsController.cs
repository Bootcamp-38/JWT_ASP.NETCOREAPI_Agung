...
namespace JWT_ASPNetCore_Agung.Controllers
{
    ...
    public class UserApplicationsController : ControllerBase
    {
        ...
        public async Task<int> Create(UserApplication data)
        {
            ...
            var result = await Task.FromResult(_dapper.Insert<int>("[dbo].[SP_Insert_UserApplication]", dbparams, commandType: CommandType.StoredProcedure));
            return result;
        }
        ...
        public Task<int> Update(UserApplication data)
        {
            ...
            var updateEmp = Task.FromResult(_dapper.Update<int>("[dbo].[SP_Update_UserApplication]",
                            dbparams,
